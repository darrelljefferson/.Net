...
namespace nbcorlandoDailyDataDump
{
    class Program
    {
        ...
        {
            Log.Init(@"e:\projects\NBC\NbcOrlandoDaily_log");
            ...
            string exportPath = @"e:\projects\NBC\";

            DateTime now = DateTime.Now;
            // DateTime now = Convert.ToDateTime("2011-05-22");
            ...
            //DateTime yesterday = Convert.ToDateTime("2011-05-21");
            ...
            Console.WriteLine("Generating flat files");
            ...
            Console.WriteLine("upload flat files");
