...
namespace PheaaEcoreDailyExporter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //DateTime start = Convert.ToDateTime("2011-06-02");
            //DateTime start = DateTime.Now.AddDays(-1);  brain's version
            DateTime start = DateTime.Now.AddDays(0);   

            //DateTime end = Convert.ToDateTime("2011-06-02");
