...
namespace PheaaDailyReportingExport
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] nameArray66885 = {"JOIN_DATE","Segment"};
            string[] idArray66886 = {"33630","45208"};
            string[] nameArray69061 = {"First Name","Last Name","JOIN_DATE",
                                      "Segment"};
            string[] idArray69061 = {"1","2","33630","45208" };
            string[] nameArray71195 = {"First Name","Last Name","UNQID","ARC",
                                      "JOIN_DATE"};
            string[] idArray71195 = { "1", "2", "52534", "33630","53418"};
            string[] nameArray79580 = {"First Name","Last Name","UNQID","ARC",
                                      "JOIN_DATE"};
            string[] idArray79580 = { "53418", "1", "2", "52534", "33630" };
