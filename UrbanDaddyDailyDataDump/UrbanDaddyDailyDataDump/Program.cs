...
namespace UrbanDaddyDump
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Log.Init(@"c:\temp\UrbandDaddy_Log_");
            ...
            string exportDirectoryPath = @"z:\djefferson\public\";
            ...
            */
            ...
            string sentReportName = "spec_sent_";
            string messageReportName = "spec_message_";
            string bounceReportName = "spec_bounce_";
            string opensReportName = "spec_opens_";
            string clicksReportName = "spec_clicks_";
            string memberReportName = "spec_members_";
            ...
            Console.WriteLine("Building Clicks Track files at " + DateTime.Today);
            Log.WriteLine("");
            GenerateFlatFile.ExportClicksToCSVFile(connString, string.Concat(exportDirectoryPath, clicksReportName), yesterdayDate);
            Log.WriteLine("");
